...
__interrupt void TIMER_B0_CCR0(void)
{
	...
	if(timer_b0_interrupts[TimerB0CCR0ISR] != 0) {
		ret = timer_b0_interrupts[TimerB0CCR0ISR]((TIMER_R(TimerB0)));
	}
...
__interrupt void TIMER_B0_TAIV(void)
{
	...
	case 2: 	                        // CCR1
		if (timer_b0_interrupts[TimerB0CCR1ISR] != 0) {
			ret = timer_b0_interrupts[TimerB0CCR1ISR](TIMER_R(TimerB0));
		}
		break;
	case 4:                          	// CCR2
		if (timer_b0_interrupts[TimerB0CCR2ISR] != 0) {
			ret = timer_b0_interrupts[TimerB0CCR2ISR](TIMER_R(TimerB0));
		}
		break;
	case 6:
		break;                          // reserved
	...
	case 14: 			                // overflow
		if (timer_b0_interrupts[TimerB0OVFLISR] != 0) {
			ret = timer_b0_interrupts[TimerB0OVFLISR](TIMER_R(TimerB0));
		}
		break;
	default:
		break;
...
__interrupt void TIMER_B1_CCR0(void)
{
	...
	if(timer_b1_interrupts[TimerB1CCR0ISR] != 0) {
		ret = timer_b1_interrupts[TimerB1CCR0ISR](TIMER_R(TimerB1));
	}
...
__interrupt void TIMER_B2_TAIV(void)
{
	...
	case 2: 	                        // CCR1
		if (timer_b1_interrupts[TimerB1CCR1ISR] != 0) {
			ret = timer_b1_interrupts[TimerB1CCR1ISR](TIMER_R(TimerB1));
		}
		break;
	case 4:                          	// CCR2
		if (timer_b1_interrupts[TimerB1CCR2ISR] != 0) {
			ret = timer_b1_interrupts[TimerB1CCR2ISR](TIMER_R(TimerB1));
		}
		break;
	case 6:
		break;                          // reserved
	...
	case 14: 			                // overflow
		if (timer_b1_interrupts[TimerB1OVFLISR] != 0) {
			ret = timer_b1_interrupts[TimerB1OVFLISR](TIMER_R(TimerB1));
		}
		break;
	default:
		break;
...
__interrupt void TIMER_B2_CCR0(void)
{
	...
	if(timer_b2_interrupts[TimerB2CCR0ISR] != 0) {
		ret = timer_b2_interrupts[TimerB2CCR0ISR](TIMER_R(TimerB2));
	}
...
__interrupt void TIMER_B1_TAIV(void)
{
	...
	case 2: 	                        // CCR1
		if (timer_b2_interrupts[TimerB2CCR1ISR] != 0) {
			ret = timer_b2_interrupts[TimerB2CCR1ISR](TIMER_R(TimerB2));
		}
		break;
	case 4:                          	// CCR2
		if (timer_b2_interrupts[TimerB2CCR2ISR] != 0) {
			ret = timer_b2_interrupts[TimerB2CCR2ISR](TIMER_R(TimerB2));
		}
		break;
	case 6:
		break;                          // reserved
	...
	case 14: 			                // overflow
		if (timer_b2_interrupts[TimerB2OVFLISR] != 0) {
			ret = timer_b2_interrupts[TimerB2OVFLISR](TIMER_R(TimerB2));
		}
		break;
	default:
		break;
