...
const std::string mysql_table_max_values  = "CREATE TABLE IF NOT EXISTS `SensorsMax` ( \
  ...
  `CHARGE_BAT_MAX` decimal(3,2) NOT NULL COMMENT 'Sensor max battery charge in %' \
  `RATE_BAT_MAX` decimal(3,2) NOT NULL COMMENT 'Sensor max battery charge rate in %/hr', \
...
const std::string mysql_table_min_values = "CREATE TABLE IF NOT EXISTS `SensorsMin` ( \
  ...
  `CHARGE_BAT_MIN` decimal(3,2) NOT NULL COMMENT 'Sensor min battery charge in %' \
  `RATE_BAT_MIN` decimal(3,2) NOT NULL COMMENT 'Sensor min battery charge rate in %/hr', \
...
const std::string mysql_table_avg_values = "CREATE TABLE IF NOT EXISTS `SensorsAvg` ( \
  ...
  `CHARGE_BAT_AVG` decimal(3,2) NOT NULL COMMENT 'Sensor avg battery charge in %' \
  `RATE_BAT_AVG` decimal(3,2) NOT NULL COMMENT 'Sensor avg battery charge rate in %/hr', \
...
const std::string mysql_table_protocol = "CREATE TABLE IF NOT EXISTS `%s` ( \
  ...
  `CHARGE_BAT` decimal(3,2) NOT NULL COMMENT 'Sensor battery charge in %' \
  `RATE_BAT` decimal(3,2) NOT NULL COMMENT 'Sensor battery charge rate in %/hr', \
...
const std::string mysql_insert_protocol_data = "INSERT INTO `%s` \
		(`ID`, `DATE`, `TIME`, `HDC1000_TEMP`, `HDC1000_HUMI`, `TMP102_TEMP`, `VOLT_BAT`, `CHARGE_BAT`, `RATE_BAT`, `VOLT_SOLAR`, `LPS25H_TEMP`, `LPS25H_PRESS`, `SI1147_UV`, `SI1147_VIS`, `SI1147_IR`, `DATETIME`) \
		VALUES \
		('', NOW(), NOW(), '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f', '%f' CURRENT_TIMESTAMP)";
...
`CHARGE_BAT_AVG`= (`CHARGE_BAT_AVG`  + %f) / 2 \
`RATE_BAT_AVG`= (`RATE_BAT_AVG`  + %f) / 2, \
...
(`ADDRESS`, `DATE`, `HDC1000_TEMP_AVG`, `HDC1000_HUMI_AVG`, `TMP102_TEMP_AVG`, `VOLT_BAT_AVG`, `CHARGE_BAT_AVG`, `RATE_BAT_AVG`, `VOLT_SOLAR_AVG`, `LPS25H_TEMP_AVG`, `LPS25H_PRESS_AVG`, `SI1147_UV_AVG`, `SI1147_VIS_AVG`, `SI1147_IR_AVG`) \
VALUES \
(%d, NOW(), %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f);";

const std::string mysql_insert_sensorsmax = "INSERT INTO `SensorsMax` \
(`ADDRESS`, `DATE`, `HDC1000_TEMP_MAX`, `HDC1000_HUMI_MAX`, `TMP102_TEMP_MAX`, `VOLT_BAT_MAX`, `CHARGE_BAT_MAX`, `RATE_BAT_MAX`, `VOLT_SOLAR_MAX`, `LPS25H_TEMP_MAX`, `LPS25H_PRESS_MAX`, `SI1147_UV_MAX`, `SI1147_VIS_MAX`, `SI1147_IR_MAX`) \
VALUES \
(%d, NOW(), %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f);";

const std::string mysql_insert_sensorsmin = "INSERT INTO `SensorsMin` \
(`ADDRESS`, `DATE`, `HDC1000_TEMP_MIN`, `HDC1000_HUMI_MIN`, `TMP102_TEMP_MIN`, `VOLT_BAT_MIN`, `CHARGE_BAT_MIN`, `RATE_BAT_MIN`, `VOLT_SOLAR_MIN`, `LPS25H_TEMP_MIN`, `LPS25H_PRESS_MIN`, `SI1147_UV_MIN`, `SI1147_VIS_MIN`, `SI1147_IR_MIN`) \
VALUES \
(%d, NOW(), %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f);";
